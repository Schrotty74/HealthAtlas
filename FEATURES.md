...
- Local coverage reports dates with and without values in the recent period.
...
- Open the matching public manual directly from the empty import screen.
- Optionally choose ChatGPT, Gemini or Claude for a first-start explanation. HealthAtlas copies a fixed, general question with the public manual link to the clipboard and opens the selected service only after your click.
- The prepared question never contains imported values or other local health data. You decide whether to paste it into the selected service.
