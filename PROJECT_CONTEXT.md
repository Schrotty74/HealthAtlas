...
Stand: 19. September 2026 · Releasebranch: `main`
...
- Die aktuelle öffentliche Final-Version ist `v1.0.1` mit ZIP, DMG und SHA-256-Dateien. Die aktuelle öffentliche Vorabversion ist `Bugfix 1.5.4` mit technischem Tag `v1.5.4-beta`. Sie erweitert die Streaming-Importprüfung für gültige Apple-Health-Varianten, darunter UTF-8-BOM, XML-Kopf, interne `DOCTYPE`, Kommentare, CDATA, unbekannte Erweiterungselemente und Records mit untergeordnetem Inhalt. Fehlgeformte XML-Strukturen bleiben abgewiesen; die kopierbare, datensparsame Diagnose enthält bei Stream-Parserfehlern zusätzlich Zeile und Spalte. Auf GitHub sind für diesen Testbuild ausschließlich ZIP und DMG angehängt.
