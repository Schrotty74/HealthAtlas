...
- `Scripts/publish-beta-as-final.sh` erstellt einen Final-Snapshot `X.0.0` standardmäßig aus der freigegebenen `beta`-Linie oder mit `--from-dev` direkt aus `dev` auf `main`. Die getrennten Branch-Historien bleiben dabei erhalten.
