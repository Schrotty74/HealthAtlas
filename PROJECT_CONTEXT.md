...
- Auf einem sauber geklonten Mac legt `Scripts/bootstrap-local-dev.sh` den ausschließlich lokalen Branch `dev` aus `origin/beta` an, ohne einen Remote-Tracking-Branch einzurichten, und wechselt anschließend zu `dev`.
