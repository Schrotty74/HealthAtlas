...
- `Scripts/publish-beta-as-final.sh` erstellt ausschließlich einen ausdrücklich freigegebenen Final-Snapshot `X.0.0` aus der `beta`-Linie. Die getrennten Branch-Historien bleiben dabei erhalten.
